...
def mock_settings(name: str, default: Any = None):
    if name == "ldap_base_dn":
        return "settings_base_dn"
    elif name == "ldap_group_cn":
        return "settings_group_cn"
    elif name == "ldap_object_class":
        return "settings_object_class"
    elif name == "ldap_password":
        return "settings_password"
    elif name == "ldap_search_attribute":
        return "settings_search_attribute"
    elif name == "ldap_server":
        return "settings_server"
    elif name == "ldap_username":
        return "settings_username"
    elif name == "quotaclass":
        return "settings_quota_class"
    elif name == "quotamultiplier":
        return 2
    elif name == "quotamultiplier_compute":
        return 3
    elif name == "quotamultiplier_network":
        return 4
    elif name == "quotamultiplier_storage":
        return 5
    elif name == "quota_router":
        return 6
    elif name == "has_public_network":
        return False
    elif name == "has_service_network":
        return True
    elif name == "has_shared_images":
        return True
